...
/*
	LAB Assignment #3
        Written by Chuong Dang (chuongdlb@uit.edu.vn) based on fifth.cc and simple-wifi-adhoc.cc
	References: 
        1. Konstantinos Katsaros (K.Katsaros@surrey.ac.uk), 
...
//		  	  	  	  	  	  	    "HeightAboveZ", DoubleValue(1.5));
 ...
 //Ptr<MyApp> app1 = CreateObject<MyApp> ();
  ...
  // Trace devices (pcap)
  wifiPhy.EnablePcap ("lab3-replace-dev0", devices.Get(0));
  wifiPhy.EnablePcap ("lab3-replace-dev1", devices.Get(1));
  wifiPhy.EnablePcap ("lab3-replace-dev2", devices.Get(2));
  wifiPhy.EnablePcap ("lab3-replace-dev3", devices.Get(3));
  // Flow Monitor
